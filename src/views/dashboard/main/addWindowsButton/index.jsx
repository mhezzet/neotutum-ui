...
export const AddWindowsButton = () => {
  ...
  const onAssociationsClick = useCallback(async () => {
    ...
    setWindowsState(prevWindows => [
      { type: 'data', data: { type: 'BPMN Associations', associations: data.data } },
      ...prevWindows,
    ])
  ...
  const onEntitiesClick = useCallback(async () => {
    ...
    setWindowsState(prevWindows => [
      { type: 'data', data: { type: 'BPMN Entities', entities: data.data } },
      ...prevWindows,
    ])
  ...
  const onSequenceFlowsClick = useCallback(async () => {
    ...
    setWindowsState(prevWindows => [
      { type: 'data', data: { type: 'BPMN SequenceFlows', sequenceFlows: data.data } },
      ...prevWindows,
    ])
    setIsLoading(false)
  }, [setWindowsState])
  ...
  const onLanesClick = useCallback(async () => {
    ...
    setWindowsState(prevWindows => [
      { type: 'data', data: { type: 'Lanes', lanes: data.data } },
      ...prevWindows,
    ])
    setIsLoading(false)
  }, [setWindowsState])
